...
async function updateBalance(){
	...
	msg += 'Total ' + signers.length + ' addresses' + '<br/>'
	for(s of signers){
		balance = await s.getBalance()
		msg += s.address + ' ' + balance / 10**18 + ' eth  <br/>'
	}
	$("#address-result").html(msg)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
contractAddress = '0x982a5a3F6ABFD179B3f7649af37942235a90935f'
...
async function callContract(contract){
	r = await contract.mintTokens(2, gasConfig)
	console.log(r)
}
...
$("#test-action").on('click', async function(e) {
	...
	const settings = {
	    "async": true,
	    "crossDomain": true,
	    "url": "https://api.opensea.io/api/v1/assets?owner=0x71cDC583eD5DbE24a136877E95108736CE63E76A&order_direction=desc&asset_contract_address=0x2c8678f04e0aa12bd40280d110e69de1f8421c9b&limit=20&include_orders=false",
	    "method": "GET",
	    "headers": {
	        "Accept": "application/json",
	        "X-API-KEY": "e34a5960d01447d49a9b247d447cf076"
	    }
	};
